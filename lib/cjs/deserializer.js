...
function makeTypeErrorMessage(expectedType, actualType, memberName) {
    var expectedTypeName = typeof expectedType === 'function'
        ? (0, helpers_1.nameof)(expectedType)
        : expectedType;
    var actualTypeName = typeof actualType === 'function' ? (0, helpers_1.nameof)(actualType) : actualType;
...
function srcTypeNameForDebug(sourceObject) {
    return sourceObject == null ? 'undefined' : (0, helpers_1.nameof)(sourceObject.constructor);
}
function deserializeDirectly(sourceObject, typeDescriptor, knownTypes, objectName) {
    if (sourceObject.constructor !== typeDescriptor.ctor) {
        throw new TypeError(makeTypeErrorMessage((0, helpers_1.nameof)(typeDescriptor.ctor), sourceObject.constructor, objectName));
    }
    return sourceObject;
}
function convertAsObject(sourceObject, typeDescriptor, knownTypes, memberName, deserializer) {
    ...
    if ((sourceObjectMetadata === null || sourceObjectMetadata === void 0 ? void 0 : sourceObjectMetadata.isExplicitlyMarked) === true) {
        ...
        var classOptions_1 = (0, options_base_1.mergeOptions)(deserializer.options, sourceMetadata_1.options);
        sourceMetadata_1.dataMembers.forEach(function (objMemberMetadata, propKey) {
            var objMemberValue = sourceObject[propKey];
            var objMemberDebugName = "".concat((0, helpers_1.nameof)(sourceMetadata_1.classType), ".").concat(propKey);
            ...
            if (objMemberMetadata.deserializer != null) {
                revivedValue = objMemberMetadata.deserializer(objMemberValue, {
                    fallback: function (so, td) { return deserializer.convertSingleValue(so, (0, type_descriptor_1.ensureTypeDescriptor)(td), knownTypes); },
                });
            }
            ...
            try {
                ...
                if (targetObject == null) {
                    throw new TypeError("Cannot deserialize ".concat(memberName, ":")
                        ...
                        + ", but '".concat((0, helpers_1.nameof)(sourceObjectMetadata === null || sourceObjectMetadata === void 0 ? void 0 : sourceObjectMetadata.classType), "' was expected."));
                }
                    ...
                    throw new TypeError("Cannot deserialize ".concat(memberName, ":")
                        + "'initializer' returned '".concat((0, helpers_1.nameof)(targetObject.constructor), "'")
                        + ", but '".concat((0, helpers_1.nameof)(sourceObjectMetadata === null || sourceObjectMetadata === void 0 ? void 0 : sourceObjectMetadata.classType), "' was expected")
                        + ", and '".concat((0, helpers_1.nameof)(targetObject.constructor), "' is not a subtype of")
                        + " '".concat((0, helpers_1.nameof)(sourceObjectMetadata === null || sourceObjectMetadata === void 0 ? void 0 : sourceObjectMetadata.classType), "'"));
                }
            }
            catch (e) {
        ...
        if (methodName != null) {
            if (typeof targetObject[methodName] === 'function') {
                ...
                deserializer.getErrorHandler()(new TypeError("onDeserialized callback"
                    + "'".concat((0, helpers_1.nameof)(sourceObjectMetadata === null || sourceObjectMetadata === void 0 ? void 0 : sourceObjectMetadata.classType), ".").concat(methodName, "' is not a method.")));
            }
        }
        return targetObject;
    }
